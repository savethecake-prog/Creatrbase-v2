...
- **Editorial Voice and Copy System** — skill_voice, skill_copy_rules, skill_voice_memory_protocol, skill_editorial_drafting, skill_editorial_question_gen [INFERRED 0.85]
- **Creator Intelligence Prompt Suite** — prompt_knowledge_synthesis, prompt_negotiation_draft, prompt_niche_classification, prompt_pattern_mining, prompt_rate_inference [INFERRED 0.85]
- **AI for Creators Digest Full Workflow** — skill_digest_ai_for_creators, skill_newsletter_curation, skill_newsletter_summarisation, skill_newsletter_subject_lines, skill_listmonk_posting, skill_voice, skill_copy_rules [INFERRED 0.85]
- **Creator Economy Digest Full Workflow** — skill_digest_creator_economy, skill_newsletter_curation, skill_newsletter_summarisation, skill_newsletter_subject_lines, skill_listmonk_posting, skill_voice, skill_copy_rules [INFERRED 0.85]
- **SEO and Crawler Infrastructure** — CLAUDE_seo_prerendering, CLAUDE_puppeteer_prerender, robotstxt_crawl_policy, robotstxt_ai_crawlers_allow, llmstxt_creatrbase_overview [EXTRACTED 0.95]
- **Six Viability Scoring Dimensions** — concept_dimension_subscriber_momentum, concept_dimension_engagement_quality, concept_dimension_niche_commercial_value, concept_dimension_audience_geo_alignment, concept_dimension_content_consistency, concept_dimension_content_brand_alignment [EXTRACTED 1.00]
- **Four Commercial Tiers** — concept_tier_pre_commercial, concept_tier_emerging, concept_tier_viable, concept_tier_established [EXTRACTED 1.00]
- **AI Prompt Suite (Recommendation + Task + Support)** — recommendation_generation_v1_prompt, task_generation_gap_closure_v1_prompt, task_generation_maintenance_v1_prompt, support_v1_prompt [INFERRED 0.85]
- **Task Generation Engines** — task_generation_gap_closure_v1_prompt, task_generation_maintenance_v1_prompt [INFERRED 0.90]
...
Cohesion: 0.25
Nodes (16): generateBrief(), getBrief(), getNotebookKeyForContentType(), getOrRefreshBrief(), refreshCorpus(), startContentResearchWorkers(), addResearch(), addSource() (+8 more)
