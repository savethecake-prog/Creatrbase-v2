...
async function getConnectedPlatforms(userId, tenantId) {
  ...
  const profiles = await getPrisma().creatorPlatformProfile.findMany({
    ...
    select:  {
      ...
      avgViewsPerVideo60d:  true,
      avgViewsPerVideo90d:  true,
      publicUploads90d:     true,
      primaryAudienceGeo:   true,
      avgConcurrentViewers30d: true,
      tiktokFollowingCount:    true,
  ...
  return profiles.map(p => ({
    ...
    avg_views_per_video_30d:  p.avgViewsPerVideo30d !== null ? Number(p.avgViewsPerVideo30d) : null,
    avg_views_per_video_60d:  p.avgViewsPerVideo60d !== null ? Number(p.avgViewsPerVideo60d) : null,
    avg_views_per_video_90d:  p.avgViewsPerVideo90d !== null ? Number(p.avgViewsPerVideo90d) : null,
    ...
    tiktok_following_count: p.tiktokFollowingCount,
