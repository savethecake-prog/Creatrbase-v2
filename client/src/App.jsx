...
// Separated so it can call useAuth() inside AuthProvider
function AppRoutes() {
  const { user, loading } = useAuth();
  // Show banner only for unauthenticated visitors. Once consent is stored it
  // disappears until the 12-month TTL expires.
